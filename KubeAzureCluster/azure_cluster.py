...
# This script creates networking, load balancer and VM scale sets from the
# saved VM images with preinstalled kubernetes. Then it initializes and
# joins the nodes to the Kubernetes cluster.
